...
folder <- "/home/mag/repos/mbei-experiments/ExperimentC"
...
ggsave("experimentC.png", p, dpi=500, width =20, height=20, units="cm")
...
write_delim(tbl, file="experimentC.csv", delim=",")
