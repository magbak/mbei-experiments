...
folder <- "/home/mag/repos/mbei-experiments/ExperimentB"
...
tbl <- tbl %>% mutate(final_rate= replace_na(final_rate, 100.0))
...
ggsave("experimentB.png", p, dpi=500, width =20, height=20, units="cm")
...
write_delim(tbl, file="experimentB.csv", delim=",")
